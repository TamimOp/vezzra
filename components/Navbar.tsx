          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <motion.div
                ...
                className="flex items-center transition-all duration-700 ease-linear"
              >
                <Image
                  src="/assets/logo.png"
                  alt="Vezzra Logo"
      ...
      {isMobileMenuOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute top-0 right-0 h-full w-80 max-w-[85vw] bg-gray-900/95 backdrop-blur-lg border-l border-purple-500/20 shadow-2xl transform translate-x-0"
          >
